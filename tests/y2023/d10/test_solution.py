...
import pytest
from aoc.y2023.d10.solution import parse, solve_part1, solve_part2
...
def test_parse_ex01(example_path):
    tiles, cycle, start = parse(example_path)


@pytest.mark.example_path("ex01.txt")
def test_solve_part1_ex01(example_data):
    assert solve_part1(example_data) == 4


@pytest.mark.example_path("ex02.txt")
def test_solve_part1_ex02(example_data):
    assert solve_part1(example_data) == 8


@pytest.mark.example_path("ex03.txt")
def test_solve_part2_ex03(example_data):
    assert solve_part2(example_data) == 4


@pytest.mark.example_path("ex03a.txt")
def test_solve_part2_ex03a(example_data):
    assert solve_part2(example_data) == 4


@pytest.mark.example_path("ex04.txt")
def test_solve_part2_ex04(example_data):
    assert solve_part2(example_data) == 8


@pytest.mark.example_path("ex05.txt")
def test_solve_part2_ex05(example_data):
    assert solve_part2(example_data) == 10
