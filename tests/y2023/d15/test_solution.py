...
import pytest
from aoc.y2023.d15.solution import parse, solve_part1, solve_part2
...
def test_solve_part1_ex00():
    assert solve_part1(["HASH"]) == 52


@pytest.mark.example_path("ex01.txt")
def test_solve_part1_ex01(example_data):
    assert solve_part1(example_data) == 1320


@pytest.mark.example_path("ex01.txt")
def test_solve_part2_ex01_times1(example_data):
    assert solve_part2(example_data) == 145
